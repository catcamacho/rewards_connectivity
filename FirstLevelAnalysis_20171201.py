...
betaseriesflow.connect([(infosource, datasource,[('subjid','subjid')]),
                        ...
                        (HRFfitting, thresh_HRFfit_map, [('tstats','in_file')]),
...
betaseriesflow.run('MultiProc', plugin_args={'n_procs': 16})
...
template = {'task_mask': firstlevel_dir + '/HRFfitMask/{subjid}_t{timepoint}/_thresh_HRFfit_map0/tstat1_thresh.nii'}
taskmask_grabber = Node(SelectFiles(template), 
                        name = 'taskmask_grabber')
...
connectivityflow.connect([(infosource, datasource, [('subjid','subjid')]),
                          ...
                          (infosource, taskmask_grabber,[('subjid','subjid')]),
                          (infosource, taskmask_grabber,[('timepoint','timepoint')]),
                          ...
                          (taskmask_grabber, beta_series_conn, [('task_mask','mask')]),
