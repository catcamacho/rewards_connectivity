...
# Run GLM
extract_beta_series = Node(GLM(out_cope='cope', 
                               out_file='beta',
                               out_t_name='tstat'), 
...
betaseriesflow.base_dir = join(workflow_dir)
...
#                         ])
connectivityflow.base_dir = join(workflow_dir)
connectivityflow.write_graph(graph2use='flat')
#connectivityflow.run('MultiProc', plugin_args={'n_procs': 1})
